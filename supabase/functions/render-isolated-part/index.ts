  ...
  try {
    ...
    for (const angle of ANGLES) {
      ...
      const promptLines = isHero ? [
        ...
        ``,
        `STEP 1 — STUDY the reference images carefully. Find the ${spec.what} on this specific car.`,
        `Look at: its exact silhouette, how thick or thin it is, how aggressive its flare/curve is, the size and spacing of any vents/louvres/cutouts, the visible bolts or exposed fasteners, whether it's gloss or matte, whether the carbon weave is visible or painted over, whether it has a contrasting trim edge, body-coloured sections, etc.`,
        ``,
        `STEP 2 — RE-DRAW that exact part, isolated on a pure white background, as if photographed for THIS car's parts catalogue.`,
        `This is NOT a generic Pandem / Liberty Walk / Rocket Bunny part — it is THIS car's part. If the reference shows a smooth painted flare, draw a smooth painted flare. If the reference shows exposed twill carbon with riveted tabs, draw exactly that. If the reference shows a subtle 20mm flare, do NOT draw a wild 80mm overfender.`,
        ``,
        ...
        `- Match the material, finish, colour, and surface treatment seen on the reference car EXACTLY. Do not default to black carbon if the reference shows painted body colour.`,
        `- Photorealistic 4k product photo. No car body around it. No text, no watermarks, no logos.`,
      ] : [
